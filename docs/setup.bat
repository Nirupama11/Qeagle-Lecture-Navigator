...
REM Lecture Navigator - Windows Setup Script
REM Sets up the complete RAG-powered Lecture Navigator system

echo.
echo  Lecture Navigator Setup Starting...
...
if not exist "backend\.env" (
    ...
    echo   DB_URI=your-database-uri-here
    echo   DB_NAME=lecturenavigator
...
echo.
echo Next steps:
echo 1. Update backend\.env with your API keys and DB details
